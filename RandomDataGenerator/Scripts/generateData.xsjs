...
$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "itVendor");
var itVendor = $.Pinaki.RandomDataGenerator.Scripts.Libs.itVendor;

$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "creditorAccount");
var creditorAccount = $.Pinaki.RandomDataGenerator.Scripts.Libs.creditorAccount;

$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "purchaseOrder");
var purchaseOrder = $.Pinaki.RandomDataGenerator.Scripts.Libs.purchaseOrder;

$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "reportingUnit");
var reportingUnit = $.Pinaki.RandomDataGenerator.Scripts.Libs.reportingUnit;

$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "projects");
var projects = $.Pinaki.RandomDataGenerator.Scripts.Libs.projects;

$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "wbs");
var wbs = $.Pinaki.RandomDataGenerator.Scripts.Libs.wbs;

$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "invoiceDocument");
var invoiceDocument = $.Pinaki.RandomDataGenerator.Scripts.Libs.invoiceDocument;


$.import("Pinaki.RandomDataGenerator.Scripts.Libs", "actualCostAccounting");
...
var dataGenerator = function(e){
	...
	this.aBaseTables=['"PINAKIP"."analyticscloud.db.CIO::CostCenter"','"PINAKIP"."analyticscloud.db.CIO::CostPool"','"PINAKIP"."analyticscloud.db.CIO::ChartofAccounts"','"PINAKIP"."analyticscloud.db.CIO::ITVendors"','"PINAKIP"."analyticscloud.db.CIO::CreditorAccount"','"PINAKIP"."analyticscloud.db.CIO::PurchaseOrders"','"PINAKIP"."analyticscloud.db.CIO::ReportingUnit"','"PINAKIP"."analyticscloud.db.CIO::Projects"','"PINAKIP"."analyticscloud.db.CIO::WBS"','"PINAKIP"."analyticscloud.db.CIO::Invoices"','"PINAKIP"."analyticscloud.db.CIO::AccountingDocumentsActuals"']; 
	/*U*/	this.distinctCostCenteres = ['Database & DWH Management','Master Data Management','Application Management','Application Maintenance & Lifecycle Mgmt.','Application Support','IT Operations','Service Integration','Data Center Management','Workplace Management','LAN Management','WAN Management','Hosting & Storage','IT Support & Service Desk','IT Security Operations','Country IT','Country IT UK','Country IT USA','Country IT China','Country IT Region Europe','Country IT Region Americas','Country IT Region APAC','Business Partnering','BP Divison 1','BP Divison 2','BP Divison 3'];
	...
	/*U*/	this.costPoolName = ['Kinray Vitamin A D','Lisinopril','CENTER-AL - AMBROSIA ACANTHICARPA POLLEN','Lubriderm Daily','Glimepiride','Medulla Arnica','Johnson Grass Pollen','Enteric Coated Aspirin','VAQTA','Norditropin','Glimepiride','NEXIUM','Indomethacin','Amoxicillin','SHISEIDO SHEER AND PERFECT COMPACT (REFILL)','VENLAFAXINE HYDROCHLORIDE','Oxycodone and Acetaminophen','Xyzal','Tobramycin','Labetalol HCL'];
	...
	/*U*/	this.projectCategory = ['Internal','External'];
	/*U*/	this.projectFundType = ['Client','Internal','COE-Budget'];
	/*U*/	this.projBudgetCurrency = ['EUR','USD','AUD','INR','YEN'];
...
if(mode == 'status'){ 
	...
	$.response.setBody(JSON.stringify({data : {
		costCenteres :genObj.arrayToObj(genObj.distinctCostCenteres),
		userNames :genObj.arrayToObj(genObj.distinctNames),
		costPoolName :genObj.arrayToObj(genObj.costPoolName),
	...
	genObj.distinctCostCenteres = genObj.objToArray(oData.advancedSettings.costCenter);
	genObj.distinctNames = genObj.objToArray(oData.advancedSettings.userNames);
	genObj.costPoolName = genObj.objToArray(oData.advancedSettings.costPool);
